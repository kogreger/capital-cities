...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="radius" symbollevels="0" type="graduatedSymbol">
    <ranges>
      <range symbol="0" lower="5.000000" upper="10.000000" label="5.0000 - 10.0000"/>
      <range symbol="1" lower="10.000000" upper="15.000000" label="10.0000 - 15.0000"/>
      <range symbol="2" lower="15.000000" upper="20.000000" label="15.0000 - 20.0000"/>
      <range symbol="3" lower="20.000000" upper="25.000000" label="20.0000 - 25.0000"/>
      <range symbol="4" lower="25.000000" upper="30.000000" label="25.0000 - 30.0000"/>
      <range symbol="5" lower="30.000000" upper="35.000000" label="30.0000 - 35.0000"/>
      <range symbol="6" lower="35.000000" upper="40.000000" label="35.0000 - 40.0000"/>
      <range symbol="7" lower="40.000000" upper="45.000000" label="40.0000 - 45.0000"/>
      <range symbol="8" lower="45.000000" upper="50.000000" label="45.0000 - 50.0000"/>
    </ranges>
    <symbols>
      ...
      <symbol alpha="1" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_unit" v="MM"/>
          <prop k="color" v="207,237,238,255"/>
          <prop k="color_border" v="0,0,0,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="style" v="solid"/>
      ...
      <symbol alpha="1" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_unit" v="MM"/>
          <prop k="color" v="140,210,195,255"/>
          <prop k="color_border" v="0,0,0,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="style" v="solid"/>
    ...
    <source-symbol>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_unit" v="MM"/>
          <prop k="color" v="199,173,141,255"/>
          <prop k="color_border" v="0,0,0,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="style" v="solid"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="radius"/>
  </edittypes>
  <editform>.</editform>
