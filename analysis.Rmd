...
grid.arrange(arrangeGrob(plotDhk09DistSex + 
                         ...
                         plotJkt02DistSex + 
                           ...
                           theme(legend.position = "none"),
                         plotMnl96DistSex + 
                           labs(title="Metro Manila 1996") + 
                           theme(legend.position = "none"),
                         main = "Distance Traveled, by Sex", nrow = 2),
...
grid.arrange(arrangeGrob(plotDhk09DistAge + 
                         ...
                         plotMnl96DistAge + 
                           labs(title="Metro Manila 1996") + 
                           theme(legend.position = "none"),
                         main = "Distance Traveled, by Age", nrow = 2),
             legendDistAge, heights=c(8, 2))
grid.arrange(arrangeGrob(plotDhk09DistOccupC + 
                         ...
                         plotMnl96DistOccupC + 
                           labs(title="Metro Manila 1996") + 
                           theme(legend.position = "none"),
                         main = "Distance Traveled, by Occupation Group", nrow = 2),
...
grid.arrange(arrangeGrob(plotDhk09CommTripStartHourAbs + 
                         ...
                         plotJkt02CommTripStartHourAbs + 
                           labs(title="Jakarta 2002") + 
                           theme(legend.position = "none"),
                         main = "Commuting Trips Started per Hour", nrow = 2),
