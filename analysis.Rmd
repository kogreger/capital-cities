...
## SELECT b.radius, COUNT(t.puid_s) 
## FROM dhk09.subtrip t, geodata.buffers_5km b, dhk09.point p 
## WHERE b.name = 'Dhaka' AND date_part('hour', p.pdate) = 10 AND p.puid = t.puid_s ## AND ST_Intersects(p.geom, b.geom) 
## GROUP BY b.radius;
```
